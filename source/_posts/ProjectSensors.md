...
```
Change IP settings according to your network by editting changing the code from lines 30 to 41 in the above code.

Also makesure to have SimpleTimer.h library installed.
